...
## Ordem de leitura neste projeto

1. `CLAUDE.md` — secao "Estado Atual do Projeto" (o que ja esta fora do padrao)
2. `docs/api.md` — as 50 rotas, com validacao, efeitos e desvios conhecidos
3. `docs/back.md` — arquitetura, modelo de dados, padrao-alvo
4. Este arquivo — como se comportar
5. `docs/definition-of-done.md` — antes de concluir

O MerlostoreChat e um sistema legado em transicao (Prisma → Drizzle,
[ADR-0002](docs/adr/0002-orm-transicao-prisma-drizzle.md)). As regras abaixo
valem para **codigo novo**. O codigo existente as viola em varios pontos, todos
catalogados em `docs/api.md` — ler la antes de "corrigir por conta propria" e
antes de copiar qualquer padrao do legado.
